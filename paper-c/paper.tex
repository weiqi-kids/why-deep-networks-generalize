...
$L \le (d-1)/2$). In the catastrophic regime test risk does not vanish
as $n \to \infty$, while in the tempered regime test risk decays at a
rate strictly slower than the dimension-free benign rate
$n^{-2s/(2s+1)}$ guaranteed by the benign branch of paperA's Theorem~2;
in particular the trichotomy excludes the benign rate whenever
$\beta \le \alpha + 1/2$ (see~\cite[Theorem~2 and Proposition~3]{paperA}).
